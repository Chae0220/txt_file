...
class NostalgiaForInfinityV8_9_1(IStrategy):
    INTERFACE_VERSION = 2
    ...
    def custom_sell(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        if (last_candle is not None) & (previous_candle_1 is not None) & (previous_candle_2 is not None) & (previous_candle_3 is not None) & (previous_candle_4 is not None) & (previous_candle_5 is not None):
            ...
            # Sell signal 9
            elif (last_candle['zlema_1'] < last_candle['zlema_4']) & (last_candle['open'] < last_candle['close']) & (previous_candle_1['zlema_1'] > previous_candle_1['zlema_4']):
                return 'sell_signal_9'
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #Kalman Filter        
        dataframe['closeKF'] = KalmanFilter(dataframe)
        
        #ZLEMA
        dataframe['zlema_1'] =  pta.zlma(dataframe['closeKF'], length=1)
        
        dataframe['ema_data'] = dataframe['closeKF']  + (dataframe['closeKF']  - dataframe['closeKF'].shift(2))
